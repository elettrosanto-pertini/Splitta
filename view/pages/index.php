...
<body class="has-background-light">
    ...
    <div class="columns is-flex is-justify-content-center pt-6">
        <div class="column is-8-mobile is-10-tablet is-8-desktop is-8-widescreen is-8-fullhd">
            <div class="columns">
                <div class="column is-8 has-background-light p-2 is-flex is-flex-direction-column is-justify-content-center">
                    <div class="is-flex is-flex-direction-column is-align-content-center">
                        <h3 class="title is-3">Mantieni le amicizie, dividi le spese!</h3>
                        <div class="content p-2">
                            <p>Splitta mantiene il computo delle spese alla luce del sole! <br>
                            Che sia il Gruppo dei coinquilini o della comitiva vacanze, Splitta
                            ti aiuterà a regolare i conti con i tuoi amici.
                            </p>
                        </div>
                ...
                <div id="immagine-telefono" class="column is-6-mobile has-background-light p-2" >
                    <figure class="image is-3by5">
                        <img class="has-ratio" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fi.imgur.com%2FrvwAnFV.png&f=1&nofb=1" alt="Stock Photo" style="max-height:100vh">
                    </figure>
                </div>  <!--src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fi.imgur.com%2FrvwAnFV.png&f=1&nofb=1"-->
            </div>
        </div>
    </div>
